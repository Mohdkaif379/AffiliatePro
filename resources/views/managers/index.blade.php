        ...
        <div class="mb-6 flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    View manager details in a clean light layout.
                </p>
            </div>
        </div>
                    ...
                    <tr class="hover:bg-slate-50">
                        ...
                        <td class="px-4 py-4 text-center">
                            <span class="inline-flex rounded-full px-3 py-1 text-xs font-semibold
                                {{ strtolower($manager->status) === 'active' ? 'bg-emerald-100 text-emerald-700' : 'bg-slate-200 text-slate-700' }}">
                                {{ $manager->status }}
                            </span>
                        </td>
                    </tr>
