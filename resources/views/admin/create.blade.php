...
<div class="min-h-screen flex items-center justify-center">
    <div class="w-full max-w-5xl bg-gray-900 p-4 md:p-8 border-4 border-yellow-600 shadow-lg">
        ...
        <form action="{{ route('admin.store') }}" method="POST" class="space-y-4">
            ...
            <div class="flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
                <div class="flex-1 relative">
                    <label for="password" class="block font-medium mb-1 text-white">Password</label>
                    <input type="password" name="password" id="password"
                        class="w-full border-yellow-700 border-2 px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-yellow-700" required>
            ...
            <div class="mt-4">
                ...
                <div class="space-y-2 bg-gray-900 p-3 border border-yellow-700 rounded">
                    ...
                    <div class="flex items-center justify-center gap-20 text-white text-md ml-8 mr-8">
                        ...
                        <label><input type="checkbox" name="permissions[{{ $key }}][]" value="create" class="text-yellow-600">Create</label>
                        <label><input type="checkbox" name="permissions[{{ $key }}][]" value="read" class="text-yellow-600">Read</label>
                        <label><input type="checkbox" name="permissions[{{ $key }}][]" value="update" class="text-yellow-600">Edit</label>
                        <label><input type="checkbox" name="permissions[{{ $key }}][]" value="delete" class="text-yellow-600">Delete</label>
                    </div>
                    @endforeach
            ...
            <div class="flex justify-center md:justify-start">
                <button type="submit"
                    class="w-full md:w-[150px] bg-yellow-700 text-white font-medium py-2 px-4 hover:bg-yellow-600 transition">
                    Create User
                </button>
            </div>
        </form>
