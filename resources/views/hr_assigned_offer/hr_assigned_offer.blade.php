        ...
        <div class="mb-6 flex flex-col gap-3 border-b border-slate-200 pb-5 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="flex items-center gap-2 text-3xl font-bold text-slate-900">
                    <i class="fa fa-handshake text-slate-700"></i> HR Assigned Offers
                </h1>
                <p class="mt-1 text-sm text-slate-500">
                    View and copy assigned offer links for HR users.
                </p>
            </div>
        </div>
            ...
            <table class="w-full table-auto border-collapse text-sm">
                <thead class="bg-slate-100 text-slate-700">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left font-semibold uppercase tracking-wide">HR Name</th>
